...
<head>
    ...
    <title>Reset Your RIVO9 Password</title>
    <style>
...
<body>
    <div class="container">
        ...
        <div class="content">
            ...
            <p>Hello ${username},</p>
            <p>We received a request to reset your RIVO9 account password. Please click the button below to set a new password:</p>
            <a href="${resetUrl}" class="cta-button">Reset Password</a>
            <p>If the button doesn't work, copy and paste this link into your browser:</p>
            <p><a href="${resetUrl}">${resetUrl}</a></p>
            <p>This link will expire in 1 hour for security reasons.</p>
            <p>If you didn't request this password reset, please ignore this email or contact us at <a href="mailto:support@rivo9.com">support@rivo9.com</a>.</p>
        </div>
        <div class="footer">
