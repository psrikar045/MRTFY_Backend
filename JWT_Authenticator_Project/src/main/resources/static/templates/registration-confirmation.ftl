...
<body>
    <div class="container">
        ...
        <div class="content">
            <h1>Welcome to RIVO9, ${user.firstName}!</h1>
            <p>Thank you for registering with RIVO9. To activate your account, please click the button below to confirm your email address.</p>
