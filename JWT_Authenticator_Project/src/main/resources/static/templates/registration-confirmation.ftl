        ...
        <div class="header">
            <div style="max-width: 350px; margin: 0 auto; position: relative; height: 100px;">
                ...
                <div style="position: absolute; left: 20px; top: 20px; width: 60px; height: 40px;">
                   <div style="position: absolute; left: 0px; top: 30px; width: 8px; height: 8px; background: #FF7A18; border-radius: 2px;"></div>                   <div style="position: absolute; left: 8px; top: 22px; width: 8px; height: 8px; background: #E8651A; border-radius: 2px;"></div>
